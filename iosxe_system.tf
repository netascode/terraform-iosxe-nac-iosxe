resource "iosxe_system" "system" {
  ...
  tftp_source_interface_five_gigabit_ethernet        = try(local.device_config[each.value.name].system.tftp_source_interface_type, local.defaults.iosxe.configuration.system.tftp_source_interface_type, null) == "FiveGigabitEthernet" ? try(local.device_config[each.value.name].system.tftp_source_interface_id, local.defaults.iosxe.configuration.system.tftp_source_interface_id, null) : null
  ...
  tftp_source_interface_hundred_gigabit_ethernet     = try(local.device_config[each.value.name].system.tftp_source_interface_type, local.defaults.iosxe.configuration.system.tftp_source_interface_type, null) == "HundredGigabitEthernet" ? try(local.device_config[each.value.name].system.tftp_source_interface_id, local.defaults.iosxe.configuration.system.tftp_source_interface_id, null) : null
  ...
  tftp_source_interface_twenty_five_gigabit_ethernet = try(local.device_config[each.value.name].system.tftp_source_interface_type, local.defaults.iosxe.configuration.system.tftp_source_interface_type, null) == "TwentyFiveGigabitEthernet" ? try(local.device_config[each.value.name].system.tftp_source_interface_id, local.defaults.iosxe.configuration.system.tftp_source_interface_id, null) : null
  tftp_source_interface_two_gigabit_ethernet         = try(local.device_config[each.value.name].system.tftp_source_interface_type, local.defaults.iosxe.configuration.system.tftp_source_interface_type, null) == "TwoGigabitEthernet" ? try(local.device_config[each.value.name].system.tftp_source_interface_id, local.defaults.iosxe.configuration.system.tftp_source_interface_id, null) : null
