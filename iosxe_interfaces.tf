  ...
  interfaces_port_channels = flatten([
    for device in local.devices : [
      for int in try(local.device_config[device.name].interfaces.port_channels, []) : {
        ...
        spanning_tree_portfast           = try(int.spanning_tree.portfast, local.defaults.iosxe.devices.configuration.interfaces.port_channels.spanning_tree.portfast, null)
        spanning_tree_portfast_disable   = try(int.spanning_tree.portfast_disable, local.defaults.iosxe.devices.configuration.interfaces.port_channels.spanning_tree.portfast_disable, null)
        spanning_tree_portfast_edge      = try(int.spanning_tree.portfast_edge, local.defaults.iosxe.devices.configuration.interfaces.port_channels.spanning_tree.portfast_edge, null)
        bpduguard_enable                 = try(int.spanning_tree.bpduguard, local.defaults.iosxe.devices.configuration.interfaces.port_channels.spanning_tree.bpduguard, null)
        bpduguard_disable                = try(int.spanning_tree.bpduguard_disable, local.defaults.iosxe.devices.configuration.interfaces.port_channels.spanning_tree.bpduguard_disable, null)
