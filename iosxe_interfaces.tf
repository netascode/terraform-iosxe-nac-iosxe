  ...
  interfaces_ethernets = flatten([
    for device in local.devices : [
      for int in try(local.device_config[device.name].interfaces.ethernets, []) : {
        ...
        ip_verify_unicast_source_reachable_via   = try(int.ipv4.verify_unicast_source_reachable_via, local.defaults.iosxe.devices.configuration.interfaces.ethernets.ipv4.verify_unicast_source_reachable_via, null)
        ip_verify_unicast_source_allow_self_ping = try(int.ipv4.verify_unicast_source_allow_self_ping, local.defaults.iosxe.devices.configuration.interfaces.ethernets.ipv4.verify_unicast_source_allow_self_ping, null)
        ip_verify_unicast_source_allow_default   = try(int.ipv4.verify_unicast_source_allow_default, local.defaults.iosxe.devices.configuration.interfaces.ethernets.ipv4.verify_unicast_source_allow_default, null)
  ...
  interfaces_loopbacks = flatten([
    for device in local.devices : [
      for int in try(local.device_config[device.name].interfaces.loopbacks, []) : {
        ...
        ip_verify_unicast_source_reachable_via   = try(int.ipv4.verify_unicast_source_reachable_via, local.defaults.iosxe.devices.configuration.interfaces.loopbacks.ipv4.verify_unicast_source_reachable_via, null)
        ip_verify_unicast_source_allow_self_ping = try(int.ipv4.verify_unicast_source_allow_self_ping, local.defaults.iosxe.devices.configuration.interfaces.loopbacks.ipv4.verify_unicast_source_allow_self_ping, null)
        ip_verify_unicast_source_allow_default   = try(int.ipv4.verify_unicast_source_allow_default, local.defaults.iosxe.devices.configuration.interfaces.loopbacks.ipv4.verify_unicast_source_allow_default, null)
  ...
  interfaces_vlans = flatten([
    for device in local.devices : [
      for int in try(local.device_config[device.name].interfaces.vlans, []) : {
        ...
        ip_verify_unicast_source_reachable_via   = try(int.ipv4.verify_unicast_source_reachable_via, local.defaults.iosxe.devices.configuration.interfaces.vlans.ipv4.verify_unicast_source_reachable_via, null)
        ip_verify_unicast_source_allow_self_ping = try(int.ipv4.verify_unicast_source_allow_self_ping, local.defaults.iosxe.devices.configuration.interfaces.vlans.ipv4.verify_unicast_source_allow_self_ping, null)
        ip_verify_unicast_source_allow_default   = try(int.ipv4.verify_unicast_source_allow_default, local.defaults.iosxe.devices.configuration.interfaces.vlans.ipv4.verify_unicast_source_allow_default, null)
        ...
        isis_area_tag                           = try(int.isis.area_tag, local.defaults.iosxe.devices.configuration.interfaces.vlans.isis.area_tag, null)
        isis                                    = try(int.isis, null) != null ? true : false
        isis_network_point_to_point             = try(int.isis.network_point_to_point, local.defaults.iosxe.devices.configuration.interfaces.vlans.isis.network_point_to_point, null)
        isis_ipv4_metric_levels = try(length(int.isis.ipv4_metric_levels) == 0, true) ? null : [for level in int.isis.ipv4_metric_levels : {
          level = try(level.level, local.defaults.iosxe.devices.configuration.interfaces.vlans.isis.ipv4_metric_levels.level, null)
          value = try(level.value, local.defaults.iosxe.devices.configuration.interfaces.vlans.isis.ipv4_metric_levels.value, null)
        }]
      }
    ]
  ])
  ...
  interfaces_port_channels = flatten([
    for device in local.devices : [
      for int in try(local.device_config[device.name].interfaces.port_channels, []) : {
        ...
        ip_verify_unicast_source_reachable_via   = try(int.ipv4.verify_unicast_source_reachable_via, local.defaults.iosxe.devices.configuration.interfaces.port_channels.ipv4.verify_unicast_source_reachable_via, null)
        ip_verify_unicast_source_allow_self_ping = try(int.ipv4.verify_unicast_source_allow_self_ping, local.defaults.iosxe.devices.configuration.interfaces.port_channels.ipv4.verify_unicast_source_allow_self_ping, null)
        ip_verify_unicast_source_allow_default   = try(int.ipv4.verify_unicast_source_allow_default, local.defaults.iosxe.devices.configuration.interfaces.port_channels.ipv4.verify_unicast_source_allow_default, null)
        ...
        isis_area_tag                           = try(int.isis.area_tag, local.defaults.iosxe.devices.configuration.interfaces.port_channels.isis.area_tag, null)
        isis                                    = try(int.isis, null) != null ? true : false
        isis_network_point_to_point             = try(int.isis.network_point_to_point, local.defaults.iosxe.devices.configuration.interfaces.port_channels.isis.network_point_to_point, null)
        isis_ipv4_metric_levels = try(length(int.isis.ipv4_metric_levels) == 0, true) ? null : [for level in int.isis.ipv4_metric_levels : {
          level = try(level.level, local.defaults.iosxe.devices.configuration.interfaces.port_channels.isis.ipv4_metric_levels.level, null)
          value = try(level.value, local.defaults.iosxe.devices.configuration.interfaces.port_channels.isis.ipv4_metric_levels.value, null)
        }]
    ...
    for device in local.devices : [
      for pc in try(local.device_config[device.name].interfaces.port_channels, []) : [
        for sub in try(pc.subinterfaces, []) : {
          ...
          isis_area_tag                           = try(sub.isis.area_tag, local.defaults.iosxe.devices.configuration.interfaces.port_channels.subinterfaces.isis.area_tag, null)
          isis                                    = try(sub.isis, null) != null ? true : false
          isis_network_point_to_point             = try(sub.isis.network_point_to_point, local.defaults.iosxe.devices.configuration.interfaces.port_channels.subinterfaces.isis.network_point_to_point, null)
          isis_ipv4_metric_levels = try(length(sub.isis.ipv4_metric_levels) == 0, true) ? null : [for level in sub.isis.ipv4_metric_levels : {
            level = try(level.level, local.defaults.iosxe.devices.configuration.interfaces.port_channels.subinterfaces.isis.ipv4_metric_levels.level, null)
            value = try(level.value, local.defaults.iosxe.devices.configuration.interfaces.port_channels.subinterfaces.isis.ipv4_metric_levels.value, null)
          }]
        }
      ]
    ]
