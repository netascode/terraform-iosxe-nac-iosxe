  ...
  device_tracking_policies = flatten([
    for device in local.devices : [
      for policy in try(local.device_config[device.name].device_tracking.policies, []) : {
        ...
        data_glean_log_only                         = try(policy.data_glean_log_only, local.defaults.iosxe.configuration.device_tracking.policies.data_glean_log_only, null)
        data_glean_recovery_dhcp                    = try(policy.data_glean_recovery_dhcp, local.defaults.iosxe.configuration.device_tracking.policies.data_glean_recovery_dhcp, null)
        data_glean_recovery_ndp                     = try(policy.data_glean_recovery_ndp, local.defaults.iosxe.configuration.device_tracking.policies.data_glean_recovery_ndp, null)
        prefix_glean                                = try(policy.prefix_glean, local.defaults.iosxe.configuration.device_tracking.policies.prefix_glean, null)
        prefix_glean_only                           = try(policy.prefix_glean_only, local.defaults.iosxe.configuration.device_tracking.policies.prefix_glean_only, null)
        destination_glean_log_only                  = try(policy.destination_glean_log_only, local.defaults.iosxe.configuration.device_tracking.policies.destination_glean_log_only, null)
        destination_glean_recovery_dhcp             = try(policy.destination_glean_recovery_dhcp, local.defaults.iosxe.configuration.device_tracking.policies.destination_glean_recovery_dhcp, null)
        protocol_arp                                = try(policy.protocol_arp, local.defaults.iosxe.configuration.device_tracking.policies.protocol_arp, null)
        protocol_arp_prefix_list                    = try(policy.protocol_arp_prefix_list, local.defaults.iosxe.configuration.device_tracking.policies.protocol_arp_prefix_list, null)
        protocol_dhcp4                              = try(policy.protocol_dhcp4, local.defaults.iosxe.configuration.device_tracking.policies.protocol_dhcp4, null)
        protocol_dhcp4_prefix_list                  = try(policy.protocol_dhcp4_prefix_list, local.defaults.iosxe.configuration.device_tracking.policies.protocol_dhcp4_prefix_list, null)
        protocol_dhcp6                              = try(policy.protocol_dhcp6, local.defaults.iosxe.configuration.device_tracking.policies.protocol_dhcp6, null)
        protocol_dhcp6_prefix_list                  = try(policy.protocol_dhcp6_prefix_list, local.defaults.iosxe.configuration.device_tracking.policies.protocol_dhcp6_prefix_list, null)
        protocol_ndp                                = try(policy.protocol_ndp, local.defaults.iosxe.configuration.device_tracking.policies.protocol_ndp, null)
        protocol_ndp_prefix_list                    = try(policy.protocol_ndp_prefix_list, local.defaults.iosxe.configuration.device_tracking.policies.protocol_ndp_prefix_list, null)
        tracking_enable                             = try(policy.tracking_enable, local.defaults.iosxe.configuration.device_tracking.policies.tracking_enable, null)
        tracking_enable_reachable_lifetime_seconds  = try(policy.tracking_enable_reachable_lifetime_seconds, local.defaults.iosxe.configuration.device_tracking.policies.tracking_enable_reachable_lifetime_seconds, null)
        tracking_enable_reachable_lifetime_infinite = try(policy.tracking_enable_reachable_lifetime_infinite, local.defaults.iosxe.configuration.device_tracking.policies.tracking_enable_reachable_lifetime_infinite, null)
        tracking_disable                            = try(policy.tracking_disable, local.defaults.iosxe.configuration.device_tracking.policies.tracking_disable, null)
        tracking_disable_stale_lifetime             = try(policy.tracking_disable_stale_lifetime, local.defaults.iosxe.configuration.device_tracking.policies.tracking_disable_stale_lifetime, null)
        limit_address_count                         = try(policy.limit_address_count, local.defaults.iosxe.configuration.device_tracking.policies.limit_address_count, null)
        security_level_glean                        = try(policy.security_level_glean, local.defaults.iosxe.configuration.device_tracking.policies.security_level_glean, null)
        security_level_guard                        = try(policy.security_level_guard, local.defaults.iosxe.configuration.device_tracking.policies.security_level_guard, null)
        security_level_inspect                      = try(policy.security_level_inspect, local.defaults.iosxe.configuration.device_tracking.policies.security_level_inspect, null)
        medium_type_wireless                        = try(policy.medium_type_wireless, local.defaults.iosxe.configuration.device_tracking.policies.medium_type_wireless, null)
      }
    ]
  ])
}
