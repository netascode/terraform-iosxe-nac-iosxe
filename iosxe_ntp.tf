resource "iosxe_ntp" "ntp" {
  ...
  trap_source_gigabit_ethernet          = (try(local.device_config[each.value.name].ntp.trap_source, null) != null) && length([for e in local.device_config[each.value.name].interfaces.ethernets : e.name if e.type == "GigabitEthernet" && e.name == try(local.device_config[each.value.name].ntp.trap_source, null)]) > 0 ? try(local.device_config[each.value.name].ntp.trap_source, null) : null
  trap_source_ten_gigabit_ethernet      = (try(local.device_config[each.value.name].ntp.trap_source, null) != null) && length([for e in local.device_config[each.value.name].interfaces.ethernets : e.name if e.type == "TenGigabitEthernet" && e.name == try(local.device_config[each.value.name].ntp.trap_source, null)]) > 0 ? try(local.device_config[each.value.name].ntp.trap_source, null) : null
  trap_source_forty_gigabit_ethernet    = (try(local.device_config[each.value.name].ntp.trap_source, null) != null) && length([for e in local.device_config[each.value.name].interfaces.ethernets : e.name if e.type == "FortyGigabitEthernet" && e.name == try(local.device_config[each.value.name].ntp.trap_source, null)]) > 0 ? try(local.device_config[each.value.name].ntp.trap_source, null) : null
  trap_source_hundred_gig_e             = (try(local.device_config[each.value.name].ntp.trap_source, null) != null) && length([for e in local.device_config[each.value.name].interfaces.ethernets : e.name if e.type == "HundredGigE" && e.name == try(local.device_config[each.value.name].ntp.trap_source, null)]) > 0 ? try(local.device_config[each.value.name].ntp.trap_source, null) : null
  trap_source_loopback                  = (try(local.device_config[each.value.name].ntp.trap_source, null) != null) && length([for e in local.device_config[each.value.name].interfaces.loopbacks : e.id if e.id == try(tonumber(local.device_config[each.value.name].ntp.trap_source), null)]) > 0 ? try(tonumber(local.device_config[each.value.name].ntp.trap_source), null) : null
  trap_source_port_channel              = (try(local.device_config[each.value.name].ntp.trap_source, null) != null) && length([for e in local.device_config[each.value.name].interfaces.port_channels : e.name if e.name == try(tonumber(local.device_config[each.value.name].ntp.trap_source), null)]) > 0 ? try(tonumber(local.device_config[each.value.name].ntp.trap_source), null) : null
  trap_source_port_channel_subinterface = (try(local.device_config[each.value.name].ntp.trap_source, null) != null) && length([for e in local.device_config[each.value.name].interfaces.port_channels.subinterfaces : e.name if e.name == try(local.device_config[each.value.name].ntp.trap_source, null)]) > 0 ? try(local.device_config[each.value.name].ntp.trap_source, null) : null
  trap_source_vlan                      = (try(local.device_config[each.value.name].ntp.trap_source, null) != null) && length([for e in local.device_config[each.value.name].interfaces.vlans : e.id if e.id == try(tonumber(local.device_config[each.value.name].ntp.trap_source), null)]) > 0 ? try(tonumber(local.device_config[each.value.name].ntp.trap_source), null) : null
