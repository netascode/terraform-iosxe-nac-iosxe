  ...
  templates = flatten([
    for device in local.devices : [
      for template in try(local.device_config[device.name].templates, []) : {
        ...
        device                                 = device.name
        name                                   = template.name
        dot1x_pae                              = try(template.network_access_control.dot1x_pae, null)
        dot1x_max_reauth_req                   = try(template.network_access_control.dot1x_max_reauth_req, null)
        dot1x_max_req                          = try(template.network_access_control.dot1x_max_req, null)
        dot1x_timeout_tx_period                = try(template.network_access_control.dot1x_timeout_tx_period, null)
        dot1x_timeout_quiet_period             = try(template.network_access_control.dot1x_timeout_quiet_period, null)
        dot1x_timeout_supp_timeout             = try(template.network_access_control.dot1x_timeout_supp_timeout, null)
        dot1x_timeout_ratelimit_period         = try(template.network_access_control.dot1x_timeout_ratelimit_period, null)
        dot1x_timeout_server_timeout           = try(template.network_access_control.dot1x_timeout_server_timeout, null)
        service_policy_type_control_subscriber = try(template.service_policy_type_control_subscriber, null)
        service_policy_input                   = try(template.service_policy_input, null)
        service_policy_output                  = try(template.service_policy_output, null)
        source_template                        = try(template.source_template, null)
        switchport_mode_trunk                  = try(template.switchport.mode, null) == "trunk" ? true : false
        switchport_mode_access                 = try(template.switchport.mode, null) == "access" ? true : false
        switchport_nonegotiate                 = try(template.switchport.nonegotiate, null)
        switchport_block_unicast               = try(template.switchport.block_unicast, null)
        switchport_port_security               = try(template.switchport.port_security, null)
        switchport_port_security_aging_static  = try(template.switchport.port_security_aging_static, null)
        switchport_port_security_aging_time    = try(template.switchport.port_security_aging_time, null)
        switchport_port_security_aging_type = try(
          try(template.switchport.port_security_aging_type, null) == "inactivity" ? true :
          try(template.switchport.port_security_aging_type, null) == "absolute" ? null :
          try(template.switchport.port_security_aging_type, null),
          null
        )
        switchport_port_security_aging_type_inactivity = try(
          try(template.switchport.port_security_aging_type, null) == "inactivity" ? true : null,
          null
        )
        switchport_port_security_maximum_range = try(length(template.switchport.port_security_maximum_ranges) == 0, true) ? null : [for range in template.switchport.port_security_maximum_ranges : {
          range       = try(range.range, null)
          vlan        = try(range.vlan, null)
          vlan_access = try(range.vlan_access, null)
        }]
        switchport_port_security_violation_protect               = try(template.switchport.port_security_violation_protect, null)
        switchport_port_security_violation_restrict              = try(template.switchport.port_security_violation_restrict, null)
        switchport_port_security_violation_shutdown              = try(template.switchport.port_security_violation_shutdown, null)
        switchport_access_vlan                                   = try(template.switchport.access_vlan, null)
        switchport_voice_vlan                                    = try(template.switchport.voice_vlan, null)
        switchport_private_vlan_host_association_primary_range   = try(template.switchport.private_vlan_host_association_primary_range, null)
        switchport_private_vlan_host_association_secondary_range = try(template.switchport.private_vlan_host_association_secondary_range, null)
        # NEW v2 trunk allowed VLANs - supports all/none/vlans
        switchport_trunk_allowed_vlans = try(
          provider::utils::normalize_vlans(
            try(template.switchport.trunk_allowed_vlans.vlans, null),
            "string"
          ),
          null
        )
        switchport_trunk_allowed_vlans_none = try(template.switchport.trunk_allowed_vlans.none, null)
        ...
        mab                                            = try(template.network_access_control.mab, null)
        mab_eap                                        = try(template.network_access_control.mab_eap, null)
        access_session_closed                          = try(template.network_access_control.access_session_closed, null)
        access_session_monitor                         = try(template.network_access_control.access_session_monitor, null)
        access_session_port_control                    = try(template.network_access_control.access_session_port_control, null)
        access_session_control_direction               = try(template.network_access_control.access_session_control_direction, null)
        access_session_host_mode                       = try(template.network_access_control.access_session_host_mode, null)
        access_session_interface_template_sticky       = try(template.network_access_control.access_session_interface_template_sticky, null)
        access_session_interface_template_sticky_timer = try(template.network_access_control.access_session_interface_template_sticky_timer, null)
        authentication_periodic                        = try(template.network_access_control.authentication_periodic, null)
        authentication_timer_reauthenticate_server     = try(template.network_access_control.authentication_timer_reauthenticate_server, null)
        authentication_timer_reauthenticate_range      = try(template.network_access_control.authentication_timer_reauthenticate_range, null)
        spanning_tree_bpduguard_enable                 = try(template.spanning_tree.bpduguard, null)
        spanning_tree_service_policy                   = try(template.spanning_tree.service_policy, null)
        spanning_tree_portfast                         = try(template.spanning_tree.portfast, null)
        spanning_tree_portfast_disable                 = try(template.spanning_tree.portfast_disable, null)
        spanning_tree_portfast_edge                    = try(template.spanning_tree.portfast_edge, null)
        spanning_tree_portfast_network                 = try(template.spanning_tree.portfast_network, null)
        storm_control_broadcast_level_pps_threshold    = try(template.storm_control.broadcast_level_pps_threshold, null)
        storm_control_broadcast_level_bps_threshold    = try(template.storm_control.broadcast_level_bps_threshold, null)
        storm_control_broadcast_level_threshold        = try(template.storm_control.broadcast_level_threshold, null)
        storm_control_multicast_level_pps_threshold    = try(template.storm_control.multicast_level_pps_threshold, null)
        storm_control_multicast_level_bps_threshold    = try(template.storm_control.multicast_level_bps_threshold, null)
        storm_control_multicast_level_threshold        = try(template.storm_control.multicast_level_threshold, null)
        storm_control_action_shutdown                  = try(template.storm_control.action_shutdown, null)
        storm_control_action_trap                      = try(template.storm_control.action_trap, null)
        load_interval                                  = try(template.load_interval, null)
        ip_dhcp_snooping_limit_rate                    = try(template.ipv4.dhcp_snooping_limit_rate, null)
        ip_dhcp_snooping_trust                         = try(template.ipv4.dhcp_snooping_trust, null)
        ip_access_group = concat(
          try(template.ipv4.access_group_in, null) != null ? [{
            direction   = "in"
            access_list = try(template.ipv4.access_group_in, null)
          }] : [],
          try(template.ipv4.access_group_out, null) != null ? [{
            direction   = "out"
            access_list = try(template.ipv4.access_group_out, null)
          }] : []
        )
        subscriber_aging_inactivity_timer_probe = try(template.subscriber_aging_inactivity_timer_probe, null)
        subscriber_aging_inactivity_timer_value = try(template.subscriber_aging_inactivity_timer_value, null)
        subscriber_aging_probe                  = try(template.subscriber_aging_probe, null)
        device_tracking                         = try(template.device_tracking, null)
        ...
        device_tracking_vlan_range       = try(template.device_tracking_vlan_range, null)
        cts_manual                       = try(template.network_access_control.cts_manual, null)
        cts_manual_policy_static_sgt     = try(template.network_access_control.cts_manual_policy_static_sgt, null)
        cts_manual_policy_static_trusted = try(template.network_access_control.cts_manual_policy_static_trusted, null)
        cts_manual_propagate_sgt         = try(template.network_access_control.cts_manual_propagate_sgt, null)
        cts_role_based_enforcement       = try(template.network_access_control.cts_role_based_enforcement, null)
      }
    ]
  ])
}
