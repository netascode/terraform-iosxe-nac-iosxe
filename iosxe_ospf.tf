  ...
  ospf_configurations_with_vrf = flatten([
    for device in local.devices : [
      for ospf in try(local.device_config[device.name].routing.ospf_processes, []) : {
        ...
        default_information_originate_metric          = try(ospf.default_information_originate_metric, local.defaults.iosxe.configuration.routing.ospf_processes.default_information_originate_metric, null)
        default_information_originate_metric_type     = try(ospf.default_information_originate_metric_type, local.defaults.iosxe.configuration.routing.ospf_processes.default_information_originate_metric_type, null)
        default_information_originate_route_map       = try(ospf.default_information_originate_route_map, local.defaults.iosxe.configuration.routing.ospf_processes.default_information_originate_route_map, null)
        ...
        redistribute_connected_subnets                = try(ospf.redistribute.connected, local.defaults.iosxe.configuration.routing.ospf_processes.redistribute.connected, null)
        redistribute_connected_metric                 = try(ospf.redistribute.connected_metric, local.defaults.iosxe.configuration.routing.ospf_processes.redistribute.connected_metric, null)
        redistribute_connected_metric_type            = try(tostring(ospf.redistribute.connected_metric_type), null)
        redistribute_connected_route_map              = try(ospf.redistribute.connected_route_map, local.defaults.iosxe.configuration.routing.ospf_processes.redistribute.connected_route_map, null)
        redistribute_connected_tag                    = try(ospf.redistribute.connected_tag, local.defaults.iosxe.configuration.routing.ospf_processes.redistribute.connected_tag, null)
        redistribute_static_subnets                   = try(ospf.redistribute.static, local.defaults.iosxe.configuration.routing.ospf_processes.redistribute.static, null)
        redistribute_static_metric                    = try(ospf.redistribute.static_metric, local.defaults.iosxe.configuration.routing.ospf_processes.redistribute.static_metric, null)
        redistribute_static_metric_type               = try(tostring(ospf.redistribute.static_metric_type), null)
        redistribute_static_route_map                 = try(ospf.redistribute.static_route_map, local.defaults.iosxe.configuration.routing.ospf_processes.redistribute.static_route_map, null)
        redistribute_static_tag                       = try(ospf.redistribute.static_tag, local.defaults.iosxe.configuration.routing.ospf_processes.redistribute.static_tag, null)
