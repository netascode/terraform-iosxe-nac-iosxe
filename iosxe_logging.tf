resource "iosxe_logging" "logging" {
  ...
  buffered_size_legacy     = try(local.device_config[each.value.name].logging.buffered_size_legacy, local.defaults.iosxe.configuration.logging.buffered_size_legacy, null)
  buffered_severity_legacy = try(local.device_config[each.value.name].logging.buffered_severity_legacy, local.defaults.iosxe.configuration.logging.buffered_severity_legacy, null)
  ...
  console             = try(local.device_config[each.value.name].logging.console_severity, local.defaults.iosxe.configuration.logging.console_severity, null) != null ? null : try(local.device_config[each.value.name].logging.console, local.defaults.iosxe.configuration.logging.console, null)
